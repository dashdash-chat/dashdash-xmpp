...
----------------
    ...
    erlc -I /lib/ejabberd/include -pa /vagrant/ejabberd/src -o /lib/ejabberd/ebin /vagrant/ejabberd/src/mod_register.erl && cp /vagrant/ejabberd/src/ejabberd.cfg /etc/ejabberd && ejabberdctl restart
